...
![Current API Architecture (Illustrating Weaknesses)](./diagrams/scenario2-current-architecture-weaknesses.png)
...
## 7. Proposed Architecture Diagram (Option A: Shared Regional Gateway)
